    ...
    return (
        <div className="main-portfolio-writeup">
            ...
            <div className="main-portfolio-writeup-body">
                ...
                <br />
                <Image src="https://shaqportfoliostorage.blob.core.windows.net/images/tech-stack-icons.png" 
                alt="Access Blocked Image" width={450} height={0} 
                style={{ display: 'block', 
                margin: '0 auto'}}
                loading="lazy"/>
                <br /><br />
                ...
                <p style={{ marginLeft: "25px" }}><span style={{ fontWeight: "700"}}>• </span>AI Chatbot Deployment: My initial plan was to use Azure OpenAI Service to power the chatbot. However, deploying the web app as a static web app created some compatibility issues with integrating the AI service. Azure's OpenAI integration required more advanced configurations that weren’t feasible with the static hosting setup.
                <br /><br />
