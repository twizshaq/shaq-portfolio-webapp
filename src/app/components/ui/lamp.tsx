...
export default function LampDemo() {
    ...
    <div
        className={cn(
            "relative flex h-[700px] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
            className
        )}
        >
        <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
            ...
            whileInView={{ opacity: 1, width: getWidthForScreen() }}
            transition={{
                delay: 0.3,
                duration: 0.8,
                ease: "easeInOut",
            ...
            >
            <div className="absolute  w-[100%] left-0 bg-[--mainbg-color] h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
            ...
            <div className="absolute  w-[100%] right-0 bg-[--mainbg-color] h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
            </motion.div>
            <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 blur-2xl"></div>
            <div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
            <div className="absolute inset-auto z-50 h-10 w-[28rem] -translate-y-[20px] rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
            <motion.div
            initial={{ width: "8rem" }}
            whileInView={{ width: getWidthForScreen() }}
            transition={{
                delay: 0.3,
                duration: 0.8,
                ease: "easeInOut",
