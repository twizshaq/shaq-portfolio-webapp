  ...
  return (
    <div className="homeMain">
        <span className="home-page-img">
          <img src= "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/homepagemainimg.png" alt="Home Page img" />
        </span>
          <motion.div
    ...
    >
      ...
      <div className="about-me">
        ...
        <div className="testbox"><Image src="https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/memoji_icon 2.png" alt="memoji icon" width={400} height={400} priority/></div>
      </div>
    ...
    <div className="tapered-line"></div>
      ...
      <div className="experience">
        ...
        <div onClick={() => setShowDetails(!showDetails)}className="protexxa-xp">
          <Image className="protexxa_logo" src="https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/protexxa_logo.png" alt="Protexxa's logo" width={100} height={100}/>
      ...
      <div className="certifications">
        ...
        <div className="certsfade">
          <motion.div
            ...
            {[{ src: "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/az104.png", id: 'az104' },
              { src: "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/SecurityPlus.png", id: 'securityPlus' },
              { src: "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/az900.png", id: 'az900' },
              { src: "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/az104.png", id: 'az104-2' },
              { src: "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/SecurityPlus.png", id: 'securityPlus-2' },
              { src: "https://myportfoliocdnendpoint-anarfba5eg2chhte.z02.azurefd.net/images/az900.png", id: 'az900-2' }].map((logo) => (
